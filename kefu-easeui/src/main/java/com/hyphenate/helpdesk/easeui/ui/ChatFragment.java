...
public class ChatFragment extends BaseFragment implements ChatManager.MessageListener, EmojiconManager.EmojiconManagerDelegate{
     ...
     * @param visitorUserName 用户名
     */
    private void getRobotWelcome(String toChatUsername, String visitorUserName, ValueCallBack<String> valueCallBack) {
        if (messageList == null){
        ...
        if (TextUtils.isEmpty(visitorUserName)){
        ...
        ChatClient.getInstance().chatManager().getCurrentSessionId(toChatUsername, new ValueCallBack<String>() {
            ...
            public void onSuccess(String value) {
                ...
                if (value.isEmpty()){
                    requestRobotWelcome(toChatUsername, visitorUserName, valueCallBack);
                }else {
    ...
    private void showRobotWelcome(String toChatUsername, final int type, final String rob_welcome, ValueCallBack<String> valueCallBack){
        ...
        try {
            if (type == 0) {
                ...
                EMTextMessageBody body = new EMTextMessageBody(rob_welcome);
                ...
                try{
                    ...
                    Log.e(TAG,"showRobotWelcome type = 1 onError:"+e.getMessage());
                    if (valueCallBack != null){
                        valueCallBack.onError(-1,e.getMessage());
                    }
                }
                ...
                try{
                    ...
                    Log.e(TAG,"showRobotWelcome type = 2 onError:"+e.getMessage());
                    if (valueCallBack != null){
                        valueCallBack.onError(-1,e.getMessage());
                    }
                }
                ...
                try{
                    ...
                    Log.e(TAG,"showRobotWelcome type = 3 onError:"+e.getMessage());
                    if (valueCallBack != null){
                        valueCallBack.onError(-1,e.getMessage());
                    }
                }
                ...
                if (json.has("news")){
                    ...
                    try{
                        ...
                        Log.e(TAG,"showRobotWelcome type = 4 onError:"+e.getMessage());
                        if (valueCallBack != null){
                            valueCallBack.onError(-1,e.getMessage());
                        }
                    }
